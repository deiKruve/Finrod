...
package body System.BB.CPU_Primitives is
   ...
   --  jdk.pragma Machine_Attribute (Pend_SV_Handler, "naked");
   ...
   procedure Initialize_CPU is
      --  jdk.Interrupt_Stack_Table : array (System.Multiprocessors.CPU)
      Interrupt_Stack_Table : array (1 .. 1)
        of System.Address;
   ...
   begin
      ...
      --  jdk.  if Context_Switch_Needed then

      --     --  Perform a context switch because the currently executing
      --     --  thread is
      ...
      --  jdk.Enable_Interrupts (Running_Thread.Active_Priority);
