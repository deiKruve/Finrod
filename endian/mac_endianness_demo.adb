...
procedure Mac_Endianness_Demo is
   ...
   type Arp_Packet is record
      ...
      Hlen    : Byte    := 6;
      Plen    : Byte    := 4;
      Oper    : Bits_16 := 1;     -- 1 = request, 2 = reply
      Sha     : Bits_48 := 16#02345678abcd#; -- sender mac address
   end record;
   ...
   type Arp_Packet_LE is new Arp_Packet;
   for Arp_Packet_LE'Bit_Order use System.Low_Order_First;
   for Arp_Packet_LE'Scalar_Storage_Order use System.Low_Order_First;
   
   type Arp_Packet_bE is new Arp_Packet;
   for Arp_Packet_bE'Bit_Order use System.High_Order_First;
   for Arp_Packet_be'Scalar_Storage_Order use System.High_Order_First;
   ...
   A_N       : Arp_Packet    := (1, 16#0800#, 6, 4, 1, 16#02345678abcd#);
   
   A_LE_Bits : Arp_Packet_LE := (1, 16#0800#, 6, 4, 1, 16#02345678abcd#);
   A_BE_Bits : Arp_Packet_Be := (1, 16#0800#, 6, 4, 1, 16#02345678abcd#);
   
   A_Le      : Arp_Packet_LE := (1, 16#0800#, 6, 4, 1, 16#02345678abcd#);
   A_Be      : Arp_Packet_Be := (1, 16#0800#, 6, 4, 1, 16#02345678abcd#);
...
begin
   ...
   Put ("A         :"); Show (A_N'Address);
   Put ("A_LE_Bits :"); Show (A_LE_Bits'Address);
   Put ("A_BE_Bits :"); Show (A_BE_Bits'Address);
   Put ("A_LE      :"); Show (A_LE'Address);
   Put ("A_BE      :"); Show (A_BE'Address);
